...
if ( file_exists( plugin_dir_path( __FILE__ ) . 'tools.php' ) && false !== WP_DEBUG ) {
...
if ( ! class_exists( 'CherryWhiteLabel' ) ) {
	...
	final class CherryWhiteLabel {
		...
		/**
		 * Deactivate plugin. Clears some options.
		 *
		 * @todo To delete a rule in the .htaccess after deactivation of the plugin.
		 * @return void
		 */
